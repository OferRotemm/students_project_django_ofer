...
def add_course(request):
    ...
    try:
        if request.method=='POST':
            ...
            course=Courses(name=name, lecturer=lecturer, description=description)
            course.save()
            message = f"{name} Added successfully"
            return render(request, "courses.html", {"message":message})
        elif request.method=='GET':
            return render(request, "courses.html", {"all_lecturers":all_lecturers})
...
def search_course(request):
    ...
    return render(request, "search_courses.html", {"search_name":search_results_name})
